...
import { CaseBuild } from './components/CaseBuild';
// Import Jurisprudence if needed elsewhere, but CaseBuild is primary for CASE_BUILD view
import { Jurisprudence } from './components/Jurisprudence';
import { AppView } from './types';
import { fetchLegalNews } from './services/gemini';
import { 
  Briefcase, 
  Gavel, 
  Menu, 
...
const Dashboard = ({ onChangeView }: { onChangeView: (v: AppView) => void }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 md:px-8 lg:px-12 space-y-8 pb-12">
...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans selection:bg-amber-100 selection:text-amber-900 overflow-hidden">
      <Sidebar currentView={view} onChangeView={setView} isMobileOpen={isMobileOpen} setIsMobileOpen={setIsMobileOpen} />
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <div className="md:hidden bg-white border-b p-4 flex items-center justify-between shadow-sm z-10 shrink-0">
